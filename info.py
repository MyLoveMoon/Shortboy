...
API_ID = int(environ.get('API_ID', '26305268'))
API_HASH = environ.get('API_HASH', '4e385c619185805f48427df36458d056')
BOT_TOKEN = environ.get('BOT_TOKEN', '5832256356:AAFno2sCHWrY-_ANbUC9WAVpUDWvzcTxw9o')
# Bot settings
